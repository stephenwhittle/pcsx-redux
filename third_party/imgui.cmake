...
target_include_directories(imgui_core PRIVATE
...
if (MSVC)
	target_compile_options(imgui_core PRIVATE "/FI${PCSX_ROOT_DIR}/src/forced-includes/imgui.h"
	)
else()
	target_compile_options(imgui_core PRIVATE -include "${PCSX_ROOT_DIR}/src/forced-includes/imgui.h")
endif()
